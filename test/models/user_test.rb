...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation shuld reject invalid adresses" do 
  ...
  test "password validation should reject blank password" do
    @user.password = @user.password_confirmation = " " * 6
    assert_not @user.valid?
  end
  
  test "password validation should reject short password" do 
